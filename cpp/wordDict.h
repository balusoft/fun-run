...
//  CPP Test9
//
//  Created by Balaji Cherukuri on 8/25/15.
//  Copyright (c) 2015 FooBar. All rights reserved.
//

#ifndef __CPP_Test9__wordDict__
#define __CPP_Test9__wordDict__
#include <vector>
#include <string>
#include <iostream>
#include <list>
    ...
    {
        {
            ...
            std::cout << std::boolalpha << "sw: ... >> " << trie.startsWith("...") << " \n";
            
            std::cout << std::boolalpha << "sw: ... >> " << trie.search("...") << " \n";
...
#endif /* defined(__CPP_Test9__wordDict__) */
