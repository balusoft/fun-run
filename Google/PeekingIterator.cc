/**
284. Peeking Iterator   My Submissions QuestionEditorial Solution
Total Accepted: 19103 Total Submissions: 56973 Difficulty: Medium
...
public:
  PeekingIterator(const vector<int>& nums) : Iterator(nums), peekValue(0), peekSet(false) {
